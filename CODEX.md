---
id: nizamiq-codex-cli-config
title: "NizamIQ — OpenAI Codex CLI Configuration (CODEX.md)"
description: "Hook file that configures OpenAI Codex CLI to discover and enforce NizamIQ ecosystem governance."
status: STABLE
last_audited: "2026-02-22"
authoritative_source: "https://github.com/nizamiq/nizamiq-methodology/blob/main/tools/CODEX.md"
version: 2.0.0
---

# NizamIQ Governance — OpenAI Codex CLI Configuration

This file configures OpenAI Codex CLI to operate within the NizamIQ ecosystem governance framework.
