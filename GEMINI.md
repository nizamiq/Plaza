---
id: nizamiq-gemini-cli-config
title: "NizamIQ — Gemini CLI / Jules Configuration (GEMINI.md)"
description: "Hook file that configures Google Gemini CLI and Jules to discover and enforce NizamIQ ecosystem governance."
status: STABLE
last_audited: "2026-02-22"
authoritative_source: "https://github.com/nizamiq/nizamiq-methodology/blob/main/tools/GEMINI.md"
version: 2.0.0
---

# NizamIQ Governance — Gemini CLI / Jules Configuration

This file configures Google Gemini CLI and Jules to operate within the NizamIQ ecosystem governance framework.
